// /api/chat.js - Enhanced multi-provider API handler
    ...
    try {
        ...
        switch (provider) {
            ...
            case 'mistral':
                ...
                break;
            default:
                // Fallback sequence - try all providers in order of speed/cost
                try {
                    rawContent = await callGroqAPI(prompt, model);
                } catch (groqError) {
                    try {
        ...
        // Clean out any formatting wrappers if generated by the AI
...
async function callGroqAPI(prompt, model = "llama-3.1-70b-versatile") {
    ...
    const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
        ...
        body: JSON.stringify({
            ...
            max_tokens: 1000 // Token efficiency
        })
    });
...
async function callMistralAPI(prompt) {
    ...
    const response = await fetch("https://api.mistral.ai/v1/chat/completions", {
        ...
        body: JSON.stringify({
            model: "mistral-small-latest", // Fast and efficient
            messages: [
                { role: "system", content: SYSTEM_INSTRUCTION },
                { role: "user", content: prompt }
            ],
